...
export class DefaultApi extends runtime.BaseAPI {
     ...
     * Root endpoint
     */
    async getWelcomeRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<WelcomeResponse>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => WelcomeResponseFromJSON(jsonValue));
    }

    /**
     * Root endpoint
     */
    async getWelcome(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<WelcomeResponse> {
